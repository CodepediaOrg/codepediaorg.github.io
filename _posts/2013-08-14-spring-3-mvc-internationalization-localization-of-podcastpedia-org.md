...
<pre class="lang:default decode:true" title="Spring application context snippet">&lt;!-- Application Message Bundle --&gt;
...
<div>
  ...
  <pre class="lang:default decode:true " title="localeResolver application context">&lt;bean id="localeResolver"&gt;
...
<div>
  ...
  <pre class="lang:xhtml decode:true" title="LocaleChangeInterceptor Spring app context">&lt;mvc:interceptors&gt;
...
<pre class="lang:xhtml decode:true">&lt;div id="flags"&gt;
    &lt;a href="?lang=en"&gt;
...
<pre class="lang:java mark:4,5 decode:true">@ModelAttribute
...
<pre>ExpiresByType text/html                 "access plus 0 seconds"
....
Header set Cache-Control "max-age=0, private"</pre>
