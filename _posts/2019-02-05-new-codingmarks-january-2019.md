...
**[Advanced caching with RxJS by thoughtram](https://blog.thoughtram.io/angular/2018/03/05/advanced-caching-with-rxjs.html)**
  ...
  * **tags**: &nbsp; [angular](https://www.bookmarks.dev/search?q=[angular]), &nbsp; [caching](https://www.bookmarks.dev/search?q=[caching]), &nbsp; [rxjs](https://www.bookmarks.dev/search?q=[rxjs])
...
**[MockAPI docs](https://www.mockapi.io/docs)**
  ...
  * **tags**: &nbsp; [mocking](https://www.bookmarks.dev/search?q=[mocking]), &nbsp; [api](https://www.bookmarks.dev/search?q=[api]), &nbsp; [tools](https://www.bookmarks.dev/search?q=[tools])
...
**[java.util.concurrent - Java Concurrency Utilities](http://tutorials.jenkov.com/java-util-concurrent/index.html)**
  ...
  * **tags**: &nbsp; [java](https://www.bookmarks.dev/search?q=[java]), &nbsp; [concurrency](https://www.bookmarks.dev/search?q=[concurrency]), &nbsp; [asynchronous](https://www.bookmarks.dev/search?q=[asynchronous])
...
**[Asynchronous REST Services with JAX-RS and CompletableFuture · allegro.tech](https://allegro.tech/2014/10/async-rest.html)**
  ...
  * **tags**: &nbsp; [rest](https://www.bookmarks.dev/search?q=[rest]), &nbsp; [java](https://www.bookmarks.dev/search?q=[java]), &nbsp; [javaee](https://www.bookmarks.dev/search?q=[javaee]), &nbsp; [asynchronous](https://www.bookmarks.dev/search?q=[asynchronous])
...
**[GitHub - anaibol/awesome-serverless](https://github.com/anaibol/awesome-serverless)**
  ...
  * **tags**: &nbsp; [serverless](https://www.bookmarks.dev/search?q=[serverless]), &nbsp; [cloud](https://www.bookmarks.dev/search?q=[cloud]), &nbsp; [awesome](https://www.bookmarks.dev/search?q=[awesome]), &nbsp; [awesome-list](https://www.bookmarks.dev/search?q=[awesome-list])
...
**[Claudia.js Home Page](https://claudiajs.com/)**
  ...
  * **tags**: &nbsp; [nodejs](https://www.bookmarks.dev/search?q=[nodejs]), &nbsp; [aws](https://www.bookmarks.dev/search?q=[aws]), &nbsp; [serverless](https://www.bookmarks.dev/search?q=[serverless])
...
**[Should.js API Documentation](http://shouldjs.github.io/)**
  ...
  * **tags**: &nbsp; [testing](https://www.bookmarks.dev/search?q=[testing]), &nbsp; [bdd](https://www.bookmarks.dev/search?q=[bdd])
...
**[Ted Vinke's Blog – Java, Groovy and Grails](https://tedvinke.wordpress.com/)**
  ...
  * **tags**: &nbsp; [java](https://www.bookmarks.dev/search?q=[java]), &nbsp; [blog](https://www.bookmarks.dev/search?q=[blog])
...
**[Injection with CDI (Part I)](https://antoniogoncalves.org/2011/05/03/injection-with-cdi-part-i/)**
  ...
  * **tags**: &nbsp; [dependency-injection](https://www.bookmarks.dev/search?q=[dependency-injection]), &nbsp; [cdi](https://www.bookmarks.dev/search?q=[cdi]), &nbsp; [javaee](https://www.bookmarks.dev/search?q=[javaee])
...
**[Express Integration Testing with SuperTest · InVision Engineering Blog](https://engineering.invisionapp.com/post/express-integration-testing-supertest/)**
  ...
  * **tags**: &nbsp; [expressjs](https://www.bookmarks.dev/search?q=[expressjs]), &nbsp; [integration-testing](https://www.bookmarks.dev/search?q=[integration-testing]), &nbsp; [supertest](https://www.bookmarks.dev/search?q=[supertest]), &nbsp; [chai](https://www.bookmarks.dev/search?q=[chai])
...
**[GitHub - Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson)**
  ...
  * **tags**: &nbsp; [nodejs](https://www.bookmarks.dev/search?q=[nodejs]), &nbsp; [csv](https://www.bookmarks.dev/search?q=[csv]), &nbsp; [json](https://www.bookmarks.dev/search?q=[json])
...
**[Moment.js Home Page](http://momentjs.com/)**
  ...
  * **tags**: &nbsp; [date](https://www.bookmarks.dev/search?q=[date]), &nbsp; [datetime](https://www.bookmarks.dev/search?q=[datetime]), &nbsp; [date-manipulation](https://www.bookmarks.dev/search?q=[date-manipulation]), &nbsp; [time](https://www.bookmarks.dev/search?q=[time]), &nbsp; [javascript](https://www.bookmarks.dev/search?q=[javascript])
...
**[ CDI Reference Implementation](http://docs.jboss.org/weld/reference/latest/en-US/html_single/)**
  ...
  * **tags**: &nbsp; [weld](https://www.bookmarks.dev/search?q=[weld]), &nbsp; [dependency-injection](https://www.bookmarks.dev/search?q=[dependency-injection]), &nbsp; [javaee](https://www.bookmarks.dev/search?q=[javaee]), &nbsp; [docs](https://www.bookmarks.dev/search?q=[docs])
...
**[Oliver Gierke - Why field injection is evil](http://olivergierke.de/2013/11/why-field-injection-is-evil/)**
  ...
  * **tags**: &nbsp; [dependency-injection](https://www.bookmarks.dev/search?q=[dependency-injection]), &nbsp; [javaee](https://www.bookmarks.dev/search?q=[javaee]), &nbsp; [spring](https://www.bookmarks.dev/search?q=[spring])
...
**[The One Correct Way to do Dependency Injection](http://blog.schauderhaft.de/2012/01/01/the-one-correct-way-to-do-dependency-injection/)**
  ...
  * **tags**: &nbsp; [design-patterns](https://www.bookmarks.dev/search?q=[design-patterns]), &nbsp; [dependency-injection](https://www.bookmarks.dev/search?q=[dependency-injection])
...
**[
  ...
  * **tags**: &nbsp; [dependency-injection](https://www.bookmarks.dev/search?q=[dependency-injection])
...
**[dotenv homepage](https://github.com/motdotla/dotenv)**
  ...
  * **tags**: &nbsp; [nodejs](https://www.bookmarks.dev/search?q=[nodejs]), &nbsp; [devops](https://www.bookmarks.dev/search?q=[devops]), &nbsp; [tools](https://www.bookmarks.dev/search?q=[tools])
...
**[npm documentation  ](https://docs.npmjs.com/)**
  ...
  * **tags**: &nbsp; [npm](https://www.bookmarks.dev/search?q=[npm]), &nbsp; [docs](https://www.bookmarks.dev/search?q=[docs])
...
**[The Basics of Java Generics](https://www.baeldung.com/java-generics)**
  ...
  * **tags**: &nbsp; [java](https://www.bookmarks.dev/search?q=[java]), &nbsp; [generics](https://www.bookmarks.dev/search?q=[generics])
...
**[Using CORS - HTML5 Rocks](https://www.html5rocks.com/en/tutorials/cors/)**
  ...
  * **tags**: &nbsp; [html](https://www.bookmarks.dev/search?q=[html])
...
**[How To Serialize Enums as JSON Objects with Jackson](https://www.baeldung.com/jackson-serialize-enums)**
  ...
  * **tags**: &nbsp; [java](https://www.bookmarks.dev/search?q=[java]), &nbsp; [serialization](https://www.bookmarks.dev/search?q=[serialization]), &nbsp; [jackson](https://www.bookmarks.dev/search?q=[jackson]), &nbsp; [json](https://www.bookmarks.dev/search?q=[json])
...
**[ORM Is an Offensive Anti-Pattern ](https://www.yegor256.com/2014/12/01/orm-offensive-anti-pattern.html)**
  ...
  * **tags**: &nbsp; [orm](https://www.bookmarks.dev/search?q=[orm]), &nbsp; [java](https://www.bookmarks.dev/search?q=[java])
...
**[Finally Getting the Most out of the Java Thread Pool](https://stackify.com/java-thread-pools/)**
  ...
  * **tags**: &nbsp; [java](https://www.bookmarks.dev/search?q=[java]), &nbsp; [multithreading](https://www.bookmarks.dev/search?q=[multithreading])
...
**[Thorntail Home Page](http://thorntail.io/)**
  ...
  * **tags**: &nbsp; [javaee](https://www.bookmarks.dev/search?q=[javaee]), &nbsp; [microservices](https://www.bookmarks.dev/search?q=[microservices])
...
**[Mockito: Why You Should Not Use InjectMocks Annotation to Autowire Fields – Ted Vinke's Blog](https://tedvinke.wordpress.com/2014/02/13/mockito-why-you-should-not-use-injectmocks-annotation-to-autowire-fields/)**
  ...
  * **tags**: &nbsp; [javaee](https://www.bookmarks.dev/search?q=[javaee]), &nbsp; [mockito](https://www.bookmarks.dev/search?q=[mockito]), &nbsp; [testing](https://www.bookmarks.dev/search?q=[testing]), &nbsp; [mocking](https://www.bookmarks.dev/search?q=[mocking])
...
**[Jest · 🃏 Delightful JavaScript Testing](https://jestjs.io/)**
  ...
  * **tags**: &nbsp; [javascript](https://www.bookmarks.dev/search?q=[javascript]), &nbsp; [testing](https://www.bookmarks.dev/search?q=[testing]), &nbsp; [reactjs](https://www.bookmarks.dev/search?q=[reactjs])
...
**[CodeMirror](http://codemirror.net/)**
  ...
  * **tags**: &nbsp; [javascript](https://www.bookmarks.dev/search?q=[javascript]), &nbsp; [tools](https://www.bookmarks.dev/search?q=[tools])
...
**[How To Use Jersey Client Efficiently](https://blogs.oracle.com/japod/how-to-use-jersey-client-efficiently)**
  ...
  * **tags**: &nbsp; [rest-client](https://www.bookmarks.dev/search?q=[rest-client]), &nbsp; [jersey](https://www.bookmarks.dev/search?q=[jersey])
...
**[5 Commands for Checking Memory Usage in Linux](https://www.linux.com/learn/5-commands-checking-memory-usage-linux)**
  ...
  * **tags**: &nbsp; [linux](https://www.bookmarks.dev/search?q=[linux]), &nbsp; [memory-management](https://www.bookmarks.dev/search?q=[memory-management])
...
**[What We Got Wrong: Lessons from the Birth of Microservices - YouTube](https://www.youtube.com/watch?v=-pDyNsB9Zr0)**
  ...
  * **tags**: &nbsp; [microservices](https://www.bookmarks.dev/search?q=[microservices]), &nbsp; [software-architecture](https://www.bookmarks.dev/search?q=[software-architecture])
...
**[Mongoose - SubDocuments](https://mongoosejs.com/docs/subdocs.html)**
  ...
  * **tags**: &nbsp; [mongoose](https://www.bookmarks.dev/search?q=[mongoose]), &nbsp; [mongodb](https://www.bookmarks.dev/search?q=[mongodb])
...
Architectural Styles and the Design of Network-based Software Architectures
  ...
  * **tags**: &nbsp; [rest](https://www.bookmarks.dev/search?q=[rest])
...
**[RESTEasy Client API](https://www.baeldung.com/resteasy-client-tutorial)**
  ...
  * **tags**: &nbsp; [rest](https://www.bookmarks.dev/search?q=[rest]), &nbsp; [rest-client](https://www.bookmarks.dev/search?q=[rest-client]), &nbsp; [resteasy](https://www.bookmarks.dev/search?q=[resteasy])
...
**[Istanbul, a JavaScript test coverage tool.](https://istanbul.js.org/)**
  ...
  * **tags**: &nbsp; [testing](https://www.bookmarks.dev/search?q=[testing]), &nbsp; [test-coverage](https://www.bookmarks.dev/search?q=[test-coverage])
