...
The bookmarks on [www.codever.dev](https://www.codever.dev/) are persisted in a [MongoDB Server](https://docs.mongodb.com/manual/).
...
the [MongoDB Setup For Production](https://github.com/CodeverDotDev/codever/wiki/MongoDB-Setup-for-Production) wiki page for commands related to that.
