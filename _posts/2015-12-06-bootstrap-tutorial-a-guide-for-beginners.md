...
<p style="text-align: justify;">
  <strong>Bootstrap saves you a lot of time</strong> – The framework includes predefined CSS classes, styled HTML components and configured Javascript plugins ready to use, to help developers design pages better and faster.<!--more-->
</p>
...
<p style="text-align: justify;">
  You’ll learn the power and flexibility of the framework with through step-by-step explanations and examples. We will cover the full range of topics, from the simplest to the more advanced.<!--more-->
</p>
   ...
   margin: 3px 0;
    ...
    $('[data-toggle="tooltip"]').tooltip()
          ...
          <div id="”project”">
            ...
            <pre class="lang:default decode:true">&lt;div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="10000" &gt;</pre>
...
&lt;/ul&gt;</pre>
            ...
            <p>
              In the project files, we have added background images <strong>images/background.</strong>
            </p>
            ...
            <pre class="lang:default decode:true">#banner {
    background: url("../images/background/bg-1.jpg");
   	background-size: cover;
            ...
            <p>
              We hope you enjoyed this tutorial.<br /> You are now well on your way to creating some awesome pages.
            </p>
            
            <p>
              To further your learning with Bootstrap, watch <a href="https://www.udemy.com/up-and-running-with-bootstrap-3/?utm_source=blog&utm_medium=udemyads&utm_content=post146143&utm_campaign=content-marketing-blog&xref=blog">Start Now With Bootstrap</a> and create a portfolio website with HTML, CSS & Bootstrap. These 5 hours of video content will get you up to speed with the front-end framework. Practice makes perfect.
            </p>
            
            <p>
              <em>Photo courtesy of Unsplash and Freepik</em>
            </p>
