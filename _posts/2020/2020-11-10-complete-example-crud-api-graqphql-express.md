...
As you might recall from my previous post [GraphQL Resources to help you get started]({% post_url 2020-11-05-graphql-resources-to-help-you-get-started %}),
 I have started to dig deeper into GraphQL. What better way to deepen one's knowledge than with a hands-on experience?
  ...
  To make the scenario more realistic, the API developed in GraphQL acts as integration layer to the existing [REST API](https://www.codever.dev/api/docs/)
...
You need to first set up the localhost REST api of Bookmarks.dev. Checkout the [project](https://github.com/CodeverDotDev/codever) and
 then follow the steps listed in the [README](https://github.com/CodeverDotDev/codever#readme) file of the project.
    ...
    "user": {
      ...
      "bookmarks": [
        ...
        },
        {
          ...
          "name": "Getting started with www.codever.dev",
        ...
        },
        {
          ...
          "name": "Collection of public dev bookmarks, shared with from www.codever.dev",
      ...
      "feed": [
        ...
        },
        {
          ...
          "location": "https://github.com/CodeverDotDev/codever/issues",
          "tags": [
            "bookmarksdev"
          ],
          "sourceCodeURL": "",
