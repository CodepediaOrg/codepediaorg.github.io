...
**[XSS (Cross Site Scripting) Prevention Cheat Sheet - OWASP](https://www.owasp.org/index.php/XSS_(Cross_Site_Scripting)_Prevention_Cheat_Sheet)**
  ...
  * **tags**: &nbsp; [security](https://www.bookmarks.dev/search?q=[security]), &nbsp; [cheatsheet](https://www.bookmarks.dev/search?q=[cheatsheet])
...
**[One does not simply learn to code – freeCodeCamp](https://medium.freecodecamp.org/one-does-not-simply-learn-to-code-f25bacdc5b62)**
  ...
  * **tags**: &nbsp; [coding](https://www.bookmarks.dev/search?q=[coding]), &nbsp; [marketing](https://www.bookmarks.dev/search?q=[marketing])
...
**[git-secret - A bash-tool to store your private data inside a git repository.](http://git-secret.io/)**
  ...
  * **tags**: &nbsp; [git](https://www.bookmarks.dev/search?q=[git]), &nbsp; [security](https://www.bookmarks.dev/search?q=[security]), &nbsp; [cvs](https://www.bookmarks.dev/search?q=[cvs])
...
**[Debugging - Getting Started Node.js](https://nodejs.org/en/docs/guides/debugging-getting-started/)**
  ...
  * **tags**: &nbsp; [nodejs](https://www.bookmarks.dev/search?q=[nodejs]), &nbsp; [debugging](https://www.bookmarks.dev/search?q=[debugging])
...
**[git-crypt - transparent file encryption in git](https://www.agwa.name/projects/git-crypt/)**
  ...
  * **tags**: &nbsp; [git](https://www.bookmarks.dev/search?q=[git]), &nbsp; [security](https://www.bookmarks.dev/search?q=[security])
...
**[Building Secure JavaScript Applications](https://nemethgergely.com/building-secure-javascript-applications/)**
  ...
  * **tags**: &nbsp; [javascript](https://www.bookmarks.dev/search?q=[javascript]), &nbsp; [security](https://www.bookmarks.dev/search?q=[security])
...
**[Dan Abramov - The Melting Pot of JavaScript - YouTube](https://www.youtube.com/watch?v=G39lKaONAlA)**
  ...
  * **tags**: &nbsp; [javascript](https://www.bookmarks.dev/search?q=[javascript]), &nbsp; [reactjs](https://www.bookmarks.dev/search?q=[reactjs])
...
**[How to write a cover letter - YouTube](https://www.youtube.com/watch?v=3AaEvnVjrRc&feature=youtu.be)**
  ...
  * **tags**: &nbsp; [job](https://www.bookmarks.dev/search?q=[job]), &nbsp; [writing](https://www.bookmarks.dev/search?q=[writing])
...
**[GitHub - facebook/create-react-app at master](https://github.com/facebook/create-react-app/tree/master)**
  ...
  * **tags**: &nbsp; [reactjs](https://www.bookmarks.dev/search?q=[reactjs])
  * <i class="fa fa-github fa-lg"></i> [github url](https://github.com/facebook/create-react-app/tree/master)
...
**[Inverted pyramid (journalism) - Wikipedia](https://en.wikipedia.org/wiki/Inverted_pyramid_(journalism))**
  ...
  * **tags**: &nbsp; [writing](https://www.bookmarks.dev/search?q=[writing])
