...
<a href="{{site.url}}/images/wp-content/uploads/2013/08/2-launch-eclipse.png" target="_blank"><img class="alignnone size-medium wp-image-235" src="{{site.url}}/images/wp-content/uploads/2013/08/2-launch-eclipse-300x168.png" alt="2-launch-eclipse" width="300" height="168" srcset="{{site.url}}/images/wp-content/uploads/2013/08/2-launch-eclipse-300x168.png 300w, {{site.url}}/images/wp-content/uploads/2013/08/2-launch-eclipse-1024x576.png 1024w, {{site.url}}/images/wp-content/uploads/2013/08/2-launch-eclipse-624x351.png 624w, {{site.url}}/images/wp-content/uploads/2013/08/2-launch-eclipse.png 1500w" sizes="(max-width: 300px) 100vw, 300px" /></a>
...
For code versioning I currently use Subversion (SVN), and the easiest way to integrate it in Eclipse is by using the <a title="Subversive Eclipse project" href="http://www.eclipse.org/subversive/" target="_blank">Subversive </a>project. The following steps explain how to do that:
  ...
  * Expand the **Collaboration** group and select the Subversive features that you would like to install. Certain Subversive features are required if you want to work with SVN, others are optional and offer some additional functionality. You can skip the optional features, if you wish.
    ...
    <a href="{{site.url}}/images/wp-content/uploads/2013/08/3-install-subversive.png" target="_blank"><img class="alignnone size-medium wp-image-239" src="{{site.url}}/images/wp-content/uploads/2013/08/3-install-subversive-300x277.png" alt="3-install-subversive" width="300" height="277" srcset="{{site.url}}/images/wp-content/uploads/2013/08/3-install-subversive-300x277.png 300w, {{site.url}}/images/wp-content/uploads/2013/08/3-install-subversive-1024x946.png 1024w, {{site.url}}/images/wp-content/uploads/2013/08/3-install-subversive-624x576.png 624w, {{site.url}}/images/wp-content/uploads/2013/08/3-install-subversive.png 1083w" sizes="(max-width: 300px) 100vw, 300px" /></a>
...
<a href="{{site.url}}/images/wp-content/uploads/2013/08/4-select-svn-perspective.png" target="_blank"><img class="alignnone size-medium wp-image-241" src="{{site.url}}/images/wp-content/uploads/2013/08/4-select-svn-perspective-240x300.png" alt="4-select-svn-perspective" width="240" height="300" srcset="{{site.url}}/images/wp-content/uploads/2013/08/4-select-svn-perspective-240x300.png 240w, {{site.url}}/images/wp-content/uploads/2013/08/4-select-svn-perspective.png 355w" sizes="(max-width: 240px) 100vw, 240px" /></a>
...
<p class="western">
  <a href="{{site.url}}/images/wp-content/uploads/2013/08/5-subersive-svn-connectors.png" target="_blank"><img class="alignnone size-medium wp-image-242" src="{{site.url}}/images/wp-content/uploads/2013/08/5-subersive-svn-connectors-254x300.png" alt="5-subersive-svn-connectors" width="254" height="300" srcset="{{site.url}}/images/wp-content/uploads/2013/08/5-subersive-svn-connectors-254x300.png 254w, {{site.url}}/images/wp-content/uploads/2013/08/5-subersive-svn-connectors-624x735.png 624w, {{site.url}}/images/wp-content/uploads/2013/08/5-subersive-svn-connectors.png 632w" sizes="(max-width: 254px) 100vw, 254px" /></a>
</p>
...
<a href="{{site.url}}/images/wp-content/uploads/2013/08/6-m2e-plugin.png" target="_blank"><img class="alignnone size-medium wp-image-244" src="{{site.url}}/images/wp-content/uploads/2013/08/6-m2e-plugin-216x300.png" alt="6-m2e-plugin" width="216" height="300" srcset="{{site.url}}/images/wp-content/uploads/2013/08/6-m2e-plugin-216x300.png 216w, {{site.url}}/images/wp-content/uploads/2013/08/6-m2e-plugin-624x864.png 624w, {{site.url}}/images/wp-content/uploads/2013/08/6-m2e-plugin.png 629w" sizes="(max-width: 216px) 100vw, 216px" /></a>

Install the plugin and restart Eclipse. Now you can finally go the added svn perspective and checkout your projects:

<a href="{{site.url}}/images/wp-content/uploads/2013/08/7-check-out-project.png" target="_blank"><img class="alignnone size-medium wp-image-245" src="{{site.url}}/images/wp-content/uploads/2013/08/7-check-out-project-300x235.png" alt="7-check-out-project" width="300" height="235" srcset="{{site.url}}/images/wp-content/uploads/2013/08/7-check-out-project-300x235.png 300w, {{site.url}}/images/wp-content/uploads/2013/08/7-check-out-project-1024x803.png 1024w, {{site.url}}/images/wp-content/uploads/2013/08/7-check-out-project-624x489.png 624w, {{site.url}}/images/wp-content/uploads/2013/08/7-check-out-project.png 1032w" sizes="(max-width: 300px) 100vw, 300px" /></a>
...
<a href="{{site.url}}/images/wp-content/uploads/2013/08/8-convert-maven-project.png" target="_blank"><img class="alignnone size-medium wp-image-246" src="{{site.url}}/images/wp-content/uploads/2013/08/8-convert-maven-project-300x289.png" alt="8-convert-maven-project" width="300" height="289" srcset="{{site.url}}/images/wp-content/uploads/2013/08/8-convert-maven-project-300x289.png 300w, {{site.url}}/images/wp-content/uploads/2013/08/8-convert-maven-project-624x603.png 624w, {{site.url}}/images/wp-content/uploads/2013/08/8-convert-maven-project.png 864w" sizes="(max-width: 300px) 100vw, 300px" /></a>

### <span id="Sysdeo_Eclipse_Tomcat_Launcher_plugin">Sysdeo Eclipse Tomcat Launcher plugin</span>

Apache Tomcat is the used server for <a title="Podcastpedia.org, knowledge to go" href="http://www.podcastpedia.org" target="_blank">Podcastpedia.org</a>, both in development and production. For the development environment in Eclipse I really like the [Sysdeo Eclipse Tomcat Launcher plugin.](http://www.eclipsetotale.com/tomcatPlugin.html) Download the tomcatPluginV33.zip file, unzip it under Eclipse_Home/dropins and restart Eclipse. You should now have the Tomcat buttons in your menu<a href="{{site.url}}/images/wp-content/uploads/2013/08/10-tomcat-plugin-menu-buttons.png" target="_blank"><img class="alignnone size-medium wp-image-249" src="{{site.url}}/images/wp-content/uploads/2013/08/10-tomcat-plugin-menu-buttons-300x114.png" alt="10-tomcat-plugin-menu-buttons" width="300" height="114" srcset="{{site.url}}/images/wp-content/uploads/2013/08/10-tomcat-plugin-menu-buttons-300x114.png 300w, {{site.url}}/images/wp-content/uploads/2013/08/10-tomcat-plugin-menu-buttons-624x238.png 624w, {{site.url}}/images/wp-content/uploads/2013/08/10-tomcat-plugin-menu-buttons.png 797w" sizes="(max-width: 300px) 100vw, 300px" /></a>

Before you can start Tomcat from Eclipse go to **Window > Tomcat** and set tomcat home, and other parameters if you might need:

<a href="{{site.url}}/images/wp-content/uploads/2013/08/11-tomcat-home-configuration.png" target="_blank"><img class="alignnone size-medium wp-image-250" src="{{site.url}}/images/wp-content/uploads/2013/08/11-tomcat-home-configuration-300x219.png" alt="11-tomcat-home-configuration" width="300" height="219" srcset="{{site.url}}/images/wp-content/uploads/2013/08/11-tomcat-home-configuration-300x219.png 300w, {{site.url}}/images/wp-content/uploads/2013/08/11-tomcat-home-configuration-624x456.png 624w, {{site.url}}/images/wp-content/uploads/2013/08/11-tomcat-home-configuration.png 919w" sizes="(max-width: 300px) 100vw, 300px" /></a>
...
<a href="{{site.url}}/images/wp-content/uploads/2013/08/12-install-java-ee-developer-tools.png" target="_blank"><img class="alignnone size-medium wp-image-254" src="{{site.url}}/images/wp-content/uploads/2013/08/12-install-java-ee-developer-tools-300x290.png" alt="12-install-java-ee-developer-tools" width="300" height="290" srcset="{{site.url}}/images/wp-content/uploads/2013/08/12-install-java-ee-developer-tools-300x290.png 300w, {{site.url}}/images/wp-content/uploads/2013/08/12-install-java-ee-developer-tools-1024x991.png 1024w, {{site.url}}/images/wp-content/uploads/2013/08/12-install-java-ee-developer-tools-624x604.png 624w, {{site.url}}/images/wp-content/uploads/2013/08/12-install-java-ee-developer-tools.png 1084w" sizes="(max-width: 300px) 100vw, 300px" /></a>
