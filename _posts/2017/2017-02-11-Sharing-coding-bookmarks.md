...
description: "This posts presents how www.codever.land came to life."
author: ama
...
It was also pretty clear I needed a website, to have my bookmarks accessible from everywhere. One of the hardest things
 ...
 but none of those felt quite right. Then I remembered the right thing to do, which is to place a request on the subconscious for it.
  The next morning, bam - [https://www.codever.land](www.codever.land). It shares both the philosophy of [our mission](https://www.codepedia.org/about/) and gave me a good title - **Sharing Coding Bookmarks**.
...
On the [landing page](https://www.codever.land) of the website, you can see the public bookmarks. These are private bookmarks, that users chose to share so that others can benefit. I try to make all my personal bookmarks public,
