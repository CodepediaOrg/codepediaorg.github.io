...
* they have [permalinks](https://jekyllrb.com/docs/permalinks/) set (very useful for the multi-author blog migration)
...
It is pretty well supported in Jekyll, once you are ready to get your hands a little bit dirty, but more on that in
a future post.  
